...
routes['POST']['/songs/songs'] = 'Songs#add_song'
routes['GET']['/logout'] = 'Songs#logout'
routes['GET']['/show'] = 'Songs#show'
routes['POST']['/add_to_list/<int:id>'] = 'Songs#add_to_list'
routes['GET']['/songs_added/<int:id>'] = 'Songs#songs_added'
routes['GET']['/show_song_info/<int:id>'] = 'Songs#show_song_info'
routes['GET']['/add_count/<int:id>'] = 'Songs#add_count'
routes['GET']['/user_playlist/<int:id>'] = 'Songs#user_playlist'
"""
